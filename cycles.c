            ...
            case 0x00:
                switch (funct) {
                    ...
                    case 0x03: /* sra */ reg[rd] = reg[rs] >> shamt;
                        ...
                        addToPipeline(2,rd);
                        break;// R[rd]=R[rs]≫>shamt
                    case 0x08: /* jr */ pc = reg[rs];
                        checkBubble(rs);
                        doFlush();
                        break;// PC=R[rs]
                    case 0x10: /* mfhi */ reg[rd] = hi;
                        checkBubble(CONSTHILO);
                        addToPipeline(2,rd);
                        break;// R[rd]=Hi
